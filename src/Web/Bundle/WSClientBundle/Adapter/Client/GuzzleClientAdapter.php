...
namespace Web\Bundle\WSClientBundle\Adapter\Client;

use GuzzleHttp\ClientInterface;
use Symfony\Component\EventDispatcher\EventDispatcherInterface;
use Symfony\Component\Stopwatch\Stopwatch;
use Web\Bundle\WSClientBundle\Adapter\Request\GuzzleRequestAdapter;
use Web\Bundle\WSClientBundle\Adapter\Response\GuzzleResponseAdapter;
use Web\Bundle\WSClientBundle\Adapter\Request\RequestAdapterInterface;
use Web\Bundle\WSClientBundle\Cache\CacheInterface;
...
class GuzzleClientAdapter implements ClientAdapterInterface
{
     ...
     *
     * @return \Web\Bundle\WSClientBundle\Adapter\Client\GuzzleClientAdapter
     */
    ...
    public function setCache($defaultTtl, $forceTtl, array $cache, array $options = [])
    {
        ...
        if (!is_subclass_of($this->cache, '\Web\Bundle\WSClientBundle\Cache\CacheInterface')) {
            throw new Exception('Cache service must implement Web\Bundle\WSClientBundle\Cache\CacheInterface');
        }
